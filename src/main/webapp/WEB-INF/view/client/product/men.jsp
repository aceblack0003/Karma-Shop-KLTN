        ...
        <body>
            ...
            <section class="items">
                ...
                <div class="row">
                    ...
                    <div class="col2">
                        <img class="header-img" src="/client/Images/nike-zoom.gif" alt="" />
                        <div class="items2">

                            <div class="card">
                                <img src="/client/Images/img-Nike1.jpg" alt="Shoe" style="width:100%" data-src>
                                <h3>Nike Free RN OC</h3>
                                <p class="price">$399.99</p>
                                <p><a href="./info.html">Learn More</a></p>
                            </div>
                            <div class="card">
                                <img src="/client/Images/nike-6.jpg" alt="Shoe" style="width:100%">
                                <h3>Nike Free RN OC</h3>
                                <p class="price">$299.99</p>
                                <p><a href="./info.html">Learn More</a></p>
                            </div>
                            <div class="card">
                                <img src="/client/Images/img-Nike3.jpg" alt="Shoe" style="width:100%">
                            ...
                            <div class="card">
                                <img src="/client/Images/img-Nike10.jpg" alt="Shoe" style="width:100%">
